# Example Plugin App for Alliance Auth (GitHub Version)<a name="onboarding-plugin-app-for-alliance-auth-github-version"></a>

This is an onboarding plugin app for [Alliance Auth](https://gitlab.com/allianceauth/allianceauth)
...
_(These badges are onboardings, you can and should replace them with your own)_

For the GitLab version of this onboarding app, please have a look over here, Erik
Kalkoken was so friendly to provide it » [Alliance Auth Example App (GitLab Version)](https://gitlab.com/ErikKalkoken/allianceauth-onboarding-plugin)

______________________________________________________________________

<!-- mdformat-toc start --slug=github --maxlevel=6 --minlevel=1 -->

- [Example Plugin App for Alliance Auth (GitHub Version)](#onboarding-plugin-app-for-alliance-auth-github-version)
  - [Features](#features)
...
To use this onboarding as a basis for your own development, just fork this repo and then
...
```bash
git clone https://github.com/YourName/aa-onboarding-plugin.git aa-your-app-name
cd aa-your-app-name
rm -rf .git
git init
pre-commit install
...
additional apps that might also be called onboarding.

Here is an overview of the places that you need to edit to adopt the name.

Easiest is to just find & replace `onboarding` with your new app name in all files
listed below.
...
| `./onboarding/static/onboarding/`              | Folder name                                                                            |
| `./onboarding/templates/onboarding/`           | Folder name                                                                            |
| `./pyproject.cfg`                        | Update module name for version import, update package name, update title, author, etc. |
| `./onboarding/apps.py`                      | App name                                                                               |
| `./onboarding/__init__.py`                  | App name                                                                               |
| `./onboarding/auth_hooks.py`                | Menu hook config incl. icon and label of your app's menu item appearing in the sidebar |
| `./onboarding/models.py`                    | App name                                                                               |
| `./onboarding/urls.py`                      | App name                                                                               |
| `./onboarding/views.py`                     | Permission name and template path                                                      |
| `./onboarding/templates/onboarding/base.html`  | Title of your app to be shown in all views and as title in the browser tab             |
| `./onboarding/templates/onboarding/index.html` | Template path                                                                          |
